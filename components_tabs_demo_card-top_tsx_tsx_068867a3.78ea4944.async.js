(globalThis.utooChunk_antd||(globalThis.utooChunk_antd=[])).push(["object"==typeof document?document.currentScript:void 0,917570,r=>{"use strict";var e=r.i(391398);r.i(191788);var n=r.i(952169);let a=(0,r.i(827830).createStyles)(({token:r,css:e})=>{let n=".ant-tabs";return e`
    ${n}${n}-card {
      ${n}-body {
